...
const InactivePostedJob = ({ Postedtitle, buttonColor }) => {
  ...
  const fetchGetAllActive = async () => {
    setLoading(true);
    try {
      const response = await Axios.get('/getallnotaprovedjobs'); // Check if the API endpoint is correct
...
export default InactivePostedJob;